    ...
    public sealed class HttpClientService : IDisposable
    {
        ...
        private HttpClientService()
        {
            ...
            try
            {
                ...
                // Solo configurar SSL si la plataforma lo soporta (evita errores en Windows)
#if !WINDOWS
            ...
            {
                Debug.WriteLine($"[HttpClientService] Error creating handler: {ex.Message}");
                // Fallback a handler básico
                handler = new HttpClientHandler();
            }
