...
namespace AsadorMoron.Utils
{
    static internal class Crypto
    {
        ...
        private static readonly byte[] salt = Encoding.ASCII.GetBytes("PolloAndaluz_2O21/Fran-Moi$Victor");
        private static string encryptionPassword = "PolloAndaluz_2O21/Fran-Moi$Victor";
