...
{
    public class HistoricoPedidosViewModelEst : ViewModelBase
    {
        #region Properties
        ...
        public HistoricoPedidosViewModelEst()
        {
        ...
        private void CargaPedidos()
        {
            ...
            ListPedidosTemp = new List<CabeceraPedido>(ResponseServiceWS.getHistoricoPedidosMultiAdmin(numeroDias, ids));
            TotalPedidos = 0;
