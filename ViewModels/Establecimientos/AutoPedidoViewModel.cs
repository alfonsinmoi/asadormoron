...
{
    public class AutoPedidoViewModel : ViewModelBase
    {
        public AutoPedidoViewModel()
        {
        }
        ...
        private async void Generar()
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(Nombre) || string.IsNullOrEmpty(Direccion) || string.IsNullOrEmpty(Telefono) || string.IsNullOrEmpty(Importe) || ZonaSeleccionada==null)
                ...
                /*else if (imp + ZonaSeleccionada.gastos < MiEstablecimiento.configuracion.pedidoMinimo)
                    ...
                    if (result)
                    {
                        ...
                        await Task.Run(() =>
                        {
                            MainThread.BeginInvokeOnMainThread(async () =>
                            {
                                ...
                                auto.hora = new DateTime(DateTime.Today.Year, DateTime.Today.Month, DateTime.Today.Day, Hora.Hours, Hora.Minutes, Hora.Seconds);
                                auto.idEstablecimiento = MiEstablecimiento.idEstablecimiento;
                                auto.idZona = ZonaSeleccionada.idZona;
                                auto.importe = imp;
                                auto.nombre = Nombre;
