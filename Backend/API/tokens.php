...
{
    $sql = $dbConn->prepare("SELECT * FROM qo_tokens");
      $sql->execute();
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    $sql = "INSERT INTO `qo_users`(`nombre`, `apellidos`, `email`, `password`,pin, `fechaAlta`) VALUES
          (:nombre, :apellidos, :email, :password,:pin,now())";
